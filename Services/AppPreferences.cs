...
namespace ParikramaCounter.Services
{
    ...
    {
        // All keys centralised — no string literals scattered across the codebase
        ...
        public bool IsDescendingMode         { get => Preferences.Get(Keys.IsDescendingMode,    false);   set => Preferences.Set(Keys.IsDescendingMode, value); }
        public bool AutoCountingEnabled      { get => Preferences.Get(Keys.AutoCountingEnabled,  true);   set => Preferences.Set(Keys.AutoCountingEnabled, value); }
